...
#Usage Function
Usage () {
	echo "sh automate-default-fuse-macro.sh <intermediate_results> <Time in secs> <outputDir>"
	...
	echo "Example			: sh automate-default-fuse-macro.sh 1|0 5 /home/bvangoor/fuse-playground/kernel-statistics/Stat-files/"
	exit 0
}
